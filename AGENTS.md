...
A really, really simple Markdown formatter with as few knobs as possible. Two
subcommands (`fix`, `check`), two config options (`ignore`, `use_gitignore` in
`passdown.toml`), and a fixed output style documented in
[README.md](./README.md).
